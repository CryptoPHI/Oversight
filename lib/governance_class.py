...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to coind "gobject list" output
    ...
    def coind_serialise(self):
        import coinlib
        return coinlib.SHIM_serialise_for_coind(self.serialise())
